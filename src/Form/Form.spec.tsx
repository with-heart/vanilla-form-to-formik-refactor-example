...
test('displays validation errors generated by "validate"', () => {
...
test('displays validation errors generated by "validationSchema"', async () => {
  ...
  // simulate validation-triggering interaction
  fireEvent.blur(elements.name)
  fireEvent.blur(elements.email)
  fireEvent.change(elements.password, {target: {value: 'pw1'}})
  fireEvent.blur(elements.password)

  // wait for validation promises to resolve
  await wait()
